...
extension CameraPreviewsViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.task = viewModel.fetchPreviewImage(cameraId: cameraPreview.cameraId) { [weak self] data in
            cell.currentFrameData = self?.viewModel.updateFrameCompleteness(of: cell.currentFrameData, with: data) { image in
                DispatchQueue.main.async {
